...
# 🧠 AI එකට බිස්නස් එක ගැන කියලා දෙන කොටස (System Instruction)
system_instruction = (
...
# 📍 GOOGLE MAP LOCATION එක යවන ක්‍රමය (Al Quoz, Dubai Coordinates)
...
# 🖼️ IMAGE (ပင်തූര) එකක් විස්තර (Caption) එකක් එක්ක යවන ක්‍රමය
...
def receive_message():
    ...
    try:
        if "messages" in data["entry"][0]["changes"][0]["value"]:
            ...
            # 🎙️ VOICE NOTE එකක් ආවොත් සිදුවන ක්‍රියාවලිය
            ...
            # 💬 TEXT මැසේජ් ආවොත් සිදුවන ක්‍රියාවලිය
                ...
                # 📍 LOCATION එක ඇහුවොත් කෙළින්ම මැප් කාඩ් එක සෙන්ඩ් කරලා AI එකෙන් ටෙක්ස්ට් එකක් හදනවා
                ...
                # 🖼️ NEW STOCK ඇහුවොත් පින්තූරය සෙන්ඩ් කරලා AI කැප්ෂන් එකක් හදනවා
                ...
                # 🤖 GLOBAL AI LOGIC: වෙනත් ඕනෑම ප්‍රශ්නයකට Gemini AI එකෙන් පිළිතුරු සකසයි
                else:
